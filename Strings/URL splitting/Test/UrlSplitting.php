...
class Test_UrlSplitting extends PHPUnit_Framework_TestCase
{
    ...
    public function
        testGetProtocolFromUrlWithUpperCaseProtocolMustReturnLowerCaseProtocol()
    {
    ...
    public function
        testGetProtocolFromUrlWithMixedCaseProtocolMustReturnItLowerCase()
    {
        $urlParser = new Url_Parser('HttPS://a.safe.site');
        $this->assertEquals($urlParser->getProtocol(), 'https');
    }
    ...
    public function
        testGetDomainFromUrlWithUpperCaseDomainMustReturnItLowerCase()
    {
